...
// Define $pet_id (ensure it is retrieved from a valid source, e.g., GET or POST)
    ...
    <table id="appointmentsTable" class="table table-striped table-hover">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="edit_appointment.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                    <a href="delete_appointment.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this appointment?');">Delete</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
